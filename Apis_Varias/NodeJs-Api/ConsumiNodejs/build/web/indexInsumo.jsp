            ...
            <div class="col-6">
                ...
                <form  enctype="" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select  class="form-control form-control-sm" name="categoria">
                                    ...
                                    <option>Equipo quirurgico</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" class="btn btn-success" value="Guardar insumo">
                    </div>
                </form>
            </div>
            <div class="col-6 pt-5">
                <h5 class="pt-5 pb-3">Lista de insumo</h5>
                <div style="width: 100%; height:500px; max-height: 500px; overflow-y: auto">
