...
<html>
    ...
    <body class="container" onload=""  style="background: #343A40">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link bi bi-house-fill" href="index.jsp"> Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a href="graficosExamenes.jsp" class="nav-link btn bi bi-info-circle-fill" >
                             Información
                        </a>                        
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle bi bi-file-earmark-slides-fill" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             Examenes
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <button class="dropdown-item bi bi-journal-check" data-toggle="modal" data-target="#exampleModal"> Modal examen</button>
                            <button class="dropdown-item bi bi-journal-check" data-toggle="modal" data-target="#exampleModal2"> Modal insumo</button>
                            <a class="dropdown-item bi bi-journal-plus" href="registroExamen.jsp"> Registro de examen</a>
                            <a class="dropdown-item bi bi-journal-bookmark-fill" href="registroInsumo.jsp"> Registro de examen</a>                         
                            <a class="dropdown-item bi bi-journal-bookmark" href="indexInsumo.jsp"> Listado de insumo</a>
                            <div class="dropdown-divider bi bi-pie-chart-fill"> Grafica de examenes</div>                            
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link bi bi-arrow-left-square" href="../apiphp/index.jsp"> Salir</a>
                    </li>
                </ul>

            </div>
        </nav>
    <did class="container" style="background: #343A40">
        <div class="row" >
            <div class="col-3" >  
        ...
        <div class="row">
            <div class="col-12">
                <h5 style="color: #fff" >Enfermedades</h5>
            </div>
        </div>
        <div class="row" style="background: #343A40">
            <div class="col-6 p-0 m-0">    
                <div class="card" style="width: 100%; border: none">
                    <div class="card-body" style="background: #343A40">                       
                        <div class="row" style="background: #343A40">
                            <div class="col-sm-6" style="background: #343A40">
            ...
            <div class="col-6 p-0 m-0" style="width: 100%; height:  100px" >
                <div class="card" style="width: 100%;border: none">
                    <div class="card-body" style="background: #343A40">
                        <h5 class="card-title" style="color: #fff">Promedio</h5> 
